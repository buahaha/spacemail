...
class MailApi
{
     ...
     * @return int
     */
    public function postCharactersCharacterIdMailLabels($character_id, $label, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null)
    {
     ...
     * @return array of int, HTTP status code, HTTP response headers (array of strings)
     */
    public function postCharactersCharacterIdMailLabelsWithHttpInfo($character_id, $label, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null)
    {
        $returnType = 'int';
        $request = $this->postCharactersCharacterIdMailLabelsRequest($character_id, $label, $datasource, $token, $user_agent, $x_user_agent);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postCharactersCharacterIdMailLabelsAsync($character_id, $label, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null)
    {
        return $this->postCharactersCharacterIdMailLabelsAsyncWithHttpInfo($character_id, $label, $datasource, $token, $user_agent, $x_user_agent)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postCharactersCharacterIdMailLabelsAsyncWithHttpInfo($character_id, $label, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null)
    {
        $returnType = 'int';
        $request = $this->postCharactersCharacterIdMailLabelsRequest($character_id, $label, $datasource, $token, $user_agent, $x_user_agent);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postCharactersCharacterIdMailLabelsRequest($character_id, $label, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null)
    {
        // verify the required parameter 'character_id' is set
        if ($character_id === null) {
            throw new \InvalidArgumentException(

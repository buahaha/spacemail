...
class ClonesApi
{
    ...
    {
        return $this->getCharactersCharacterIdClonesAsyncWithHttpInfo($character_id, $datasource, $token, $user_agent, $x_user_agent)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        return $this->getCharactersCharacterIdImplantsAsyncWithHttpInfo($character_id, $datasource, $token, $user_agent, $x_user_agent)
            ->then(
                function ($response) {
                    return $response[0];
                }

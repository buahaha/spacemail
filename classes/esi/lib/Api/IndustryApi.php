...
class IndustryApi
{
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCorporationCorporationIdMiningExtractionsAsync($corporation_id, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null)
    {
        return $this->getCorporationCorporationIdMiningExtractionsAsyncWithHttpInfo($corporation_id, $datasource, $token, $user_agent, $x_user_agent)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getCorporationCorporationIdMiningExtractionsRequest($corporation_id, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null)
    {

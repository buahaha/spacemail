...
/**
 * GetCorporationsCorporationIdDivisionsWallet Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GetCorporationsCorporationIdDivisionsWallet implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'get_corporations_corporation_id_divisions_wallet';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling GetCorporationsCorporationIdDivisionsWallet., must be smaller than or equal to 50.');
        }

 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GetCorporationsCorporationIdOrdersHistory200Ok implements ModelInterface, ArrayAccess
{
    ...
    public function setWalletDivision($wallet_division)
    {
        ...
        if (($wallet_division > 7)) {
            throw new \InvalidArgumentException('invalid value for $wallet_division when calling GetCorporationsCorporationIdOrdersHistory200Ok., must be smaller than or equal to 7.');
        }
        if (($wallet_division < 1)) {
            throw new \InvalidArgumentException('invalid value for $wallet_division when calling GetCorporationsCorporationIdOrdersHistory200Ok., must be bigger than or equal to 1.');
        }
